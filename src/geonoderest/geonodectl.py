...
""",
    ...
    resource_delete.add_argument(type=str, dest="pk", help="pk of resource(s) to delete (range \'1-5\',list \'1,2,3,4,5\', single \'1\') ...")
    ...
    datasets_delete.add_argument(
        type=str, dest="pk", help="pk of dataset(s) to delete (range \'1-5\',list \'1,2,3,4,5\', single \'1\') ..."
    )
    ...
    documents_delete.add_argument(
        type=str, dest="pk", help="pk of document(s) to delete (range \'1-5\',list \'1,2,3,4,5\', single \'1\')..."
    )
    ...
    maps_delete.add_argument(type=str, dest="pk", help="pk of map(s) to delete (range \'1-5\',list \'1,2,3,4,5\', single \'1\') ...")
    ...
    geoapps_delete.add_argument(type=str, dest="pk", help="pk of geoapp(s) to delete (range \'1-5\',list \'1,2,3,4,5\', single \'1\') ...")
    ...
    users_delete.add_argument(type=str, dest="pk", help="pk of user(s) to delete (range \'1-5\',list \'1,2,3,4,5\', single \'1\') ...")
